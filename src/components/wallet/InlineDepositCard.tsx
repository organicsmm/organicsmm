      ...
      <div className="three-d-card overflow-hidden relative border border-white/10">
        ...
        {step === 'verify' && (
          <div className="p-8 pt-4 space-y-6">
            ...
            {/* Telegram Support for Crypto */}
            <a
              href={TELEGRAM_SUPPORT}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-5 rounded-2xl bg-[#229ED9]/5 border border-[#229ED9]/20 hover:bg-[#229ED9]/10 transition-all group cursor-pointer"
            >
              <div className="w-12 h-12 rounded-2xl bg-[#229ED9]/20 flex items-center justify-center shrink-0">
                <Send className="h-6 w-6 text-[#229ED9]" />
              </div>
              <div className="flex-1">
                <p className="text-sm font-black text-white">Issues with Transaction?</p>
                <p className="text-[10px] text-[#229ED9] font-bold uppercase tracking-wider">Help Desk @HenryMiller08</p>
              </div>
              <MessageCircle className="h-5 w-5 text-[#229ED9]/50 group-hover:text-[#229ED9]" />
            </a>
