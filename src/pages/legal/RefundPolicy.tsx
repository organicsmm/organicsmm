        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>If you disagree with a refund decision, you may escalate by emailing <strong className="text-foreground">support@organicsmm.pro</strong> with additional evidence. We will review escalated cases within 7 business days. Our decision on escalated cases is final.</p>
            </section>
